...
const Contact = () => {
  return (
    <>
      ...
      <section class="bsb-faq-2 sec1 py-3 py-md-5 py-xl-8 m-2">
        <div className='row text-center mb-5'><h2>Frequently Asked Questions</h2></div>
        <div class="container">
              ...
              <div class="row justify-content-xl-end">
                <div class="col-12 col-xl-11">
                  <div class="accordion accordion-flush" id="accordionExample">
                    ...
                    <div class="accordion-item ">
                      <h2 class="accordion-header bg-none" id="headingTwo">
      ...
      <section class="py-3 py-md-5 py-xl-8 m-2 sec2">
        <div class="container">
          <div class="row">
            <div class="col-12 col-md-10 col-lg-8">
              <h2 class=" mb-4 mb-md-5 mb-xl-8 h1">We're always on the lookout to work with new clients. Please get in touch in one of the following ways.</h2>
            </div>
          </div>
        </div>
              ...
              <div class="border overflow-hidden">
                ...
                <form action="#!">
                  <div class="row gy-4 gy-xl-5 p-4 p-xl-5">
                    ...
                    <div class="col-12">
                      <div class="d-grid">
                        <button class="btn btn btn-lg" type="submit" style={{ backgroundColor: "#fef7e5", border: "2px solid black" }}>Send Message</button>
                      </div>
                    </div>
                  </div>
                </form>
                    ...
                    <div class="col-12 col-sm-6">
                      <div class="mb-4 mb-sm-0">
                        ...
                        <div>
                          ...
                          <p class="mb-0">
                            <a class="link-secondary text-decoration-none" href="tel:+91 9714250480">+91 9714250480</a>
                          </p>
                        </div>
                      </div>
                    </div>
                    <div class="col-12 col-sm-6">
                      <div class="mb-4 mb-sm-0">
                        ...
                        <div>
                          ...
                          <hr class="w-75 mb-3 border-dark-subtle" />
                          <p class="mb-0">
                            <a class="link-secondary text-decoration-none" href="Rudra.enterprise902@gmail.com">Rudra.enterprise902@gmail.com</a>
                          </p>
                        </div>
                      </div>
                    </div>
        ...
        <div id="map-container-google-1" class="z-depth-1-half map-container m-2" style={{ height: "500px" }}>
          <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d238133.18800756568!2d72.65748445425247!3d21.159120355995483!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be04e59411d1563%3A0xfe4558290938b042!2sSurat%2C%20Gujarat!5e0!3m2!1sen!2sin!4v1709486243758!5m2!1sen!2sin" frameborder="0"
            style={{ border: "1px solid black" }} allowfullscreen title="Google Map"></iframe>
        </div>
      </section>
    </>
  )
